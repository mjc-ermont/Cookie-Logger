...
then
	...
	make &&
	mkdir build &&
	cp release/Logger21.exe /opt/mxe/usr/$ARCH-w64-mingw32.shared/bin/libqjson.dll /opt/mxe/usr/$ARCH-w64-mingw32.shared/qt/lib/{qwt,QtCore4,QtGui4,QtSql4,QtSerialPort,QtWebKit4,QtNetwork4}.dll  build/ &&
