...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sat Jun 22 14:49:06 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Logger211.0.0/ && $(COPY_FILE) --parents tablemgr.h FenPrincipale.h dialog.h defines.h UI/mapsview.h UI/boardingtable.h InPut/serial.h InPut/sensorvalue.h InPut/sensormanager.h InPut/sensor.h InPut/fileimportdialog.h ../cookie-ChronoReaderWidget/chronoreaderwidget.h ../cookie-ChronoReaderWidget/TimeCalc/timecalcs.h ../cookie-ChronoReaderWidget/eventbox.h UI/graphicview.h .tmp/Logger211.0.0/ && $(COPY_FILE) --parents res.qrc .tmp/Logger211.0.0/ && $(COPY_FILE) --parents FenPrincipale.cpp dialog.cpp tablemgr.cpp main.cpp UI/mapsview.cpp UI/boardingtable.cpp InPut/serial.cpp InPut/sensorvalue.cpp InPut/sensormanager.cpp InPut/sensor.cpp InPut/fileimportdialog.cpp ../cookie-ChronoReaderWidget/chronoreaderwidget.cpp ../cookie-ChronoReaderWidget/TimeCalc/timecalcs.cpp ../cookie-ChronoReaderWidget/eventbox.cpp UI/graphicview.cpp .tmp/Logger211.0.0/ && $(COPY_FILE) --parents FenPrincipale.ui dialog.ui InPut/fileimportdialog.ui ../cookie-ChronoReaderWidget/chronoreaderwidget.ui ../cookie-ChronoReaderWidget/eventbox.ui .tmp/Logger211.0.0/ && (cd `dirname .tmp/Logger211.0.0` && $(TAR) Logger211.0.0.tar Logger211.0.0 && $(COMPRESS) Logger211.0.0.tar) && $(MOVE) `dirname .tmp/Logger211.0.0`/Logger211.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Logger211.0.0
...
moc_chronoreaderwidget.cpp: ../cookie-ChronoReaderWidget/eventbox.h \
		../cookie-ChronoReaderWidget/chronoreaderwidget.h
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) ../cookie-ChronoReaderWidget/chronoreaderwidget.h -o moc_chronoreaderwidget.cpp

moc_eventbox.cpp: ../cookie-ChronoReaderWidget/eventbox.h
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) ../cookie-ChronoReaderWidget/eventbox.h -o moc_eventbox.cpp
...
ui_chronoreaderwidget.h: ../cookie-ChronoReaderWidget/chronoreaderwidget.ui
	/usr/lib/i386-linux-gnu/qt4/bin/uic ../cookie-ChronoReaderWidget/chronoreaderwidget.ui -o ui_chronoreaderwidget.h

ui_eventbox.h: ../cookie-ChronoReaderWidget/eventbox.ui
	/usr/lib/i386-linux-gnu/qt4/bin/uic ../cookie-ChronoReaderWidget/eventbox.ui -o ui_eventbox.h
...
chronoreaderwidget.o: ../cookie-ChronoReaderWidget/chronoreaderwidget.cpp ../cookie-ChronoReaderWidget/chronoreaderwidget.h \
		../cookie-ChronoReaderWidget/eventbox.h \
		ui_chronoreaderwidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o chronoreaderwidget.o ../cookie-ChronoReaderWidget/chronoreaderwidget.cpp

timecalcs.o: ../cookie-ChronoReaderWidget/TimeCalc/timecalcs.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o timecalcs.o ../cookie-ChronoReaderWidget/TimeCalc/timecalcs.cpp

eventbox.o: ../cookie-ChronoReaderWidget/eventbox.cpp ../cookie-ChronoReaderWidget/eventbox.h \
		ui_eventbox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o eventbox.o ../cookie-ChronoReaderWidget/eventbox.cpp
